...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ImportDecl = 53,                /* ImportDecl  */
  YYSYMBOL_ImportSpec = 54,                /* ImportSpec  */
  YYSYMBOL_ImportPath = 55,                /* ImportPath  */
  YYSYMBOL_TopLevelDecl = 56,              /* TopLevelDecl  */
  YYSYMBOL_STAR_TopLevelDecl_SC = 57,      /* STAR_TopLevelDecl_SC  */
  YYSYMBOL_STAR_ImportDecl_SC = 58,        /* STAR_ImportDecl_SC  */
  YYSYMBOL_STAR_ImportSpec_SC = 59,        /* STAR_ImportSpec_SC  */
  YYSYMBOL_STAR_CM_ID = 60,                /* STAR_CM_ID  */
  YYSYMBOL_STAR_ConstSpec_SC = 61,         /* STAR_ConstSpec_SC  */
  YYSYMBOL_Declaration = 62,               /* Declaration  */
  YYSYMBOL_ConstDecl = 63,                 /* ConstDecl  */
  YYSYMBOL_ConstSpec = 64,                 /* ConstSpec  */
  YYSYMBOL_IdentifierList = 65             /* IdentifierList  */
};
...
static const char *const yytname[] =
{
  ...
  "BINARY_LIT", "HEX_LIT", "FLOAT_LIT", "DEC_LIT", "IMPORT", "'+'", "'-'",
  "'*'", "'/'", "';'", "'('", "')'", "'.'", "','", "$accept", "SourceFile",
  "PackageClause", "PackageName", "ImportDecl", "ImportSpec", "ImportPath",
  "TopLevelDecl", "STAR_TopLevelDecl_SC", "STAR_ImportDecl_SC",
  "STAR_ImportSpec_SC", "STAR_CM_ID", "STAR_ConstSpec_SC", "Declaration",
  "ConstDecl", "ConstSpec", "IdentifierList", YY_NULLPTR
};
...
{
      -8,   -12,     8,   -35,   -36,   -36,   -36,   -36,   -29,   -19,
     -33,     0,   -36,   -36,   -21,   -21,   -36,   -36,   -36,   -18,
     -30,   -36,   -36,   -17,   -36,   -36,   -36,   -36,   -36,   -36,
     -36,   -36,   -28,   -27,   -15,   -36,    -1,   -36,   -25,   -36,
     -36
};
...
{
       0,     0,     0,     0,     4,     3,     1,    15,    13,     0,
       0,     2,    10,    17,     0,     0,     5,     7,    14,     0,
       0,    11,    22,     0,     8,     9,    19,    21,    23,    25,
      12,     6,     0,    26,     0,    16,     0,    24,     0,    18,
      20
};
...
{
     -36,   -36,   -36,    19,   -36,     1,    -9,   -36,   -36,   -36,
     -36,   -36,   -36,   -36,   -36,   -11,   -36
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     2,     3,    15,    10,    16,    17,    20,    11,     8,
      23,    33,    34,    21,    22,    28,    29
};
...
{
       4,    26,     4,     1,    26,    24,    25,     4,     6,     7,
       9,    18,    19,    12,    30,    12,    35,    12,    39,    40,
       5,    36,     0,    38,    32,     0,    13,    27,    14,    31,
      14,    37
};

static const yytype_int8 yycheck[] =
{
      19,    19,    19,    11,    19,    14,    15,    19,     0,    44,
      39,    44,    12,    34,    44,    34,    44,    34,    19,    44,
       1,    48,    -1,    34,    23,    -1,    45,    45,    47,    46,
      47,    46
};
...
{
       0,    11,    50,    51,    19,    52,     0,    44,    58,    39,
      53,    57,    34,    45,    47,    52,    54,    55,    44,    12,
      56,    62,    63,    59,    55,    55,    19,    45,    64,    65,
      44,    46,    54,    60,    61,    44,    48,    46,    64,    19,
      44
};
