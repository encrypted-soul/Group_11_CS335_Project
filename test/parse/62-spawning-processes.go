...
// Sometimes our Go programs need to spawn other, non-Go processes. For
// example, the syntax highlighting on this site is implemented by spawning a
// pygmentize process from a Go program. Let’s look at a few examples of
// spawning processes from Go.
...
func main() {
	...
	// Output() is another helper than handles the common case of running a
